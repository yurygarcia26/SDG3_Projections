...
for (Outcome_name in Outcome_names) {
  ...
  write.xlsx(projection_df_list, paste("././Projections/Projection_Data/Covariable_Projections",
                                  Outcome_name,
                                  "Region.xlsx", sep="_"))
  
  write.xlsx(projection_df_list2, paste("././Projections/Projection_Data/Covariable_Projections",
                                       Outcome_name,
