...
```{r echo=FALSE, message=FALSE, warning=FALSE}
region_cols <- c("Ubication", "Region", "SubRegion")
  ...
  for (region_use in region_values) {
    ...
    for (var in variables_region) {
      ...
      Aggregate_Data_Region_Indicator <- indicator_data %>% group_by(Year, Region) %>%
        summarise(MedianWeightedValue=median(WeightedValueRaw),
                  MedianValue=median(Value),
                  MeanWeightedValue=mean(WeightedValueRaw),
