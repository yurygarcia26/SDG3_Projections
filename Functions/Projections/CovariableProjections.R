...
get_data_all_regions <- function(value_col_to_use){
  Aggregate_Data_Use_All <- as.data.frame(
    read.xlsx(paste(parentDir, "/Data/Imputed_data/Aggregate_Data/Aggregate_Data_ALL_REGIONS.xlsx", sep="")))
...
for (Outcome_name in Outcome_names) {
  ...
  write.xlsx(projection_df_list, paste(parentDir, "/Data/Forecasting/Projection_Covariables/Covariable_Projections_",
                                  Outcome_name,
                                  "_Region.xlsx", sep=""))
  
  write.xlsx(projection_df_list2, paste(parentDir, "/Data/Forecasting/Projection_Covariables/Covariable_Projections_",
                                       Outcome_name,
